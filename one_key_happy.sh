...
+----------------------------------------------------------------------
| 安装脚本：curl -sSO https://gh-proxy.com/https://raw.githubusercontent.com/tvfuns/bt1khappy/main/install_panel.sh && bash install_panel.sh
+----------------------------------------------------------------------
"
#while [ "$go" != 'y' ] && [ "$go" != 'n' ]
#do
...
if [ -f ${plugin_file} ];then
    ...
    wget https://gh-proxy.com/https://raw.githubusercontent.com/tvfuns/bt1khappy/main/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://gh-proxy.com/https://raw.githubusercontent.com/tvfuns/bt1khappy/main/plugin.json
...
if [ -f ${repair_file} ];then
    ...
    cd /www/server/panel/data
    wget https://gh-proxy.com/https://raw.githubusercontent.com/tvfuns/bt1khappy/main/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://gh-proxy.com/https://raw.githubusercontent.com/tvfuns/bt1khappy/main/repair.json
